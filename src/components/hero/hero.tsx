...
import myIamge from '../../images/my-image.png';
import myIamge2 from '../../images/my-image-3.jpg';
                ...
                <div className="static-hero-img">
                    <div className="static-hero-img-inner">
                        ...
                        <div className="icon-3 floating-item">
                            <img width={65} height={65}src={azureIcon} alt="" />
                        </div>
                        <div className="project">
                            <div className="icon">
                                <img width={65} height={65} src={azureDeveloperAssociateIcon} alt="" />
                            </div>
